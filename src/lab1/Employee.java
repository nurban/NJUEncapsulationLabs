...
public class Employee {
    ...
    //It is public so that it can be called from the Startup class,
    //meaning only 1 method must be called, instead of the original 3.
    public void Day() {
        this.meetWithHrForBenefitAndSalryInfo();
        this.meetDepartmentStaff();
        this.reviewDeptPolicies();
        this.moveIntoCubicle(cubeId); //passing in string because it is a parameter in the method
